...
class DSRMAC:
    def __init__(self, scheme, groups, args):
        ...
        self.hidden_states_ability = None
    ...
    def forward(self, ep_batch, states, t, test_mode=False, train_mode=False):
        # states: [bs, state_dim]
    ...
    def init_hidden(self, batch_size):
        ...
        self.hidden_states_ability = self.agent.init_hidden_ability()[0].unsqueeze(0).expand(batch_size, self.n_agents, -1)
    ...
    def load_models(self, path):
        ...
        # print(self.agent.embed_net.state_dict())
        # print(self.agent.subtask_state_encoder.state_dict())
        # print(self.agent.subtask_state_decoder.state_dict())
